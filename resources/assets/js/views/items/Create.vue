        ...
        <div class="card">
          <form action="" @submit.prevent="submitItem">
            <div class="card-body">
              ...
              <div class="form-group">
                <label class="control-label">Item Number</label><span class="text-danger"> *</span>
                <base-input
                ...
                <div v-if="$v.formData.item_no.$error">
                  <span v-if="!$v.formData.item_no.required" class="text-danger">{{ $t('validation.required') }} </span>
                  <span v-if="!$v.formData.item_no.minLength" class="text-danger">
                    {{ $tc('validation.name_min_length', $v.formData.item_no.$params.minLength.min, { count: $v.formData.item_no.$params.minLength.min }) }}
                  </span>
                </div>
              </div>
              <div class="form-group">
